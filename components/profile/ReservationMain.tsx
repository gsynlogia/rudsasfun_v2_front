 ...
 */
export default function ReservationMain({ reservation }: ReservationMainProps) {
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="text-center pt-3 sm:pt-4">
        <button className="text-xs sm:text-sm text-[#03adf0] hover:text-[#0288c7] flex items-center gap-1 mx-auto">
          ukryj szczegóły
