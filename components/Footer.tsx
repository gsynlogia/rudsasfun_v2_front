      ...
      <div className="max-w-container mx-auto px-3 sm:px-6 py-8 sm:py-12">
        ...
        <div className="sm:hidden flex flex-col items-center text-center">
          ...
          <button
            ...
            className="flex items-center gap-2 mt-2 text-sm font-medium text-gray-600 hover:text-[#03adf0] transition-colors"
          ...
          >
            {mobileExpanded ? (
              ...
              <>
                <span>Rozwiń pozostałe linki</span>
        ...
        {/* Mobile rozwinieta treść + Desktop: pełna siatka */}
        <div className={`sm:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 ${mobileExpanded ? 'block mt-6' : 'hidden sm:grid'}`}>
          {/* Na desktopie logo i social są w siatce; na mobile w wersji zwiniętej już wyświetlone */}
        ...
        {/* Rating Section – na mobile widoczna tylko po rozwinięciu */}
        <div className={`mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-200 ${!mobileExpanded ? 'hidden sm:block' : ''}`}>
        ...
        {/* Bottom Copyright – na mobile widoczna tylko po rozwinięciu */}
        <div className={`mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200 text-center ${!mobileExpanded ? 'hidden sm:block' : ''}`}>
