...
/**
 * Nowy szablon karty kwalifikacyjnej – przepisany 1:1 na podstawie /profil/aktualne-rezerwacje/[id]/karta-kwalifikacyjna.
 * Wszystkie dane z systemu są edytowalne; pola do edycji mają żółte tło (klasa .editable-field).
...
export function QualificationTemplateNew({ reservationId: reservationIdProp, reservationData, signedPayload, printMode = false, previewOnly = false, saveMode = 'client', onSaveAdmin, formSnapshotFromDb, onSaveSuccess }: QualificationFormProps) {
  ...
  useEffect(() => {
    if (readOnlyView || reservationIdProp === null || reservationIdProp === undefined) return;
